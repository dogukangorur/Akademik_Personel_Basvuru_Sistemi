            ...
            >
                <div className="bg-white dark:bg-black h-full">
                    ...
                    <PerfectScrollbar className="h-[calc(100vh-80px)] relative  bg-green-50">
                        ...
                        <li className="nav-item">
                            <NavLink to="/aday/profil-goruntule" className="group">
                                <div className="flex items-center">
                        ...
                        <li className="nav-item">
                            <NavLink to="/aday/profil" className="group">
                                <div className="flex items-center">
                                    <IconUser className="group-hover:!text-success shrink-0" />
                                    <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Akademik Profil Oluştur</span>
                                </div>
                            </NavLink>
                        </li>
