                                    ...
                                    ilanlar.map((ilan: any) => {
                                        return (
                                            <tr key={ilan.id}>
                                                ...
                                                <td>{ilan.aciklama.substring(0, 40)}...</td>
                                                <td>
                                                    {formatDate(ilan.baslangic_tarih)} / {formatDate(ilan.bitis_tarih)}
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <div className="flex w-10">
                                                        <button type="button" onClick={() => handleDuzenle(ilan.id)} className="btn btn-warning mx-1">
                                                        ...
                                                        <button
                                                            ...
                                                            onClick={() => {
                                                                setModal1(true);
                                                                setSecilenIlanId(ilan.id);
                                                            }}
                                                        >
                                                            <IconTrash className="w-4 h-4" />
                                                        </button>
                                                        <button type="button" className="btn btn-primary mx-1" onClick={() => handleGoruntule(ilan.id)}>
